...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-relayer/security) of this repository.
...
This policy covers the `rayls-sovereign-relayer` repository (the private/public relayers and the
