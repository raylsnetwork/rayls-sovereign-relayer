...
// Package repository implements the legacy public-chain (RN) Teleport bridge relayer.
//
...
// public relayer does not crash-loop while waiting for its database.
//
